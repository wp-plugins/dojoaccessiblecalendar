...
if(!dojo._hasResource["accessijit.DojoAccessibleCalendar"]){
    dojo._hasResource["accessijit.DojoAccessibleCalendar"]=true;
    dojo.provide("accessijit.DojoAccessibleCalendar");
    dojo.require("dojo.cldr.supplemental");
    dojo.require("dojo.date");
    dojo.require("dojo.date.locale");
    dojo.require("dijit._Widget");
    dojo.require("dijit._Templated");
    dojo.declare("accessijit.DojoAccessibleCalendar",[dijit._Widget,dijit._Templated],{
        templateString:dojo.cache("dijit","templates/Calendar.html","<table cellspacing=\"0\" cellpadding=\"0\" class=\"dijitCalendarContainer\" role=\"grid\" dojoAttachEvent=\"onkeypress: _onKeyPress\">\n\t<thead>\n\t\t<tr class=\"dijitReset dijitCalendarMonthContainer\" valign=\"top\">\n\t\t\t<th class='dijitReset' dojoAttachPoint=\"decrementMonth\">\n\t\t\t\t<img src=\"${_blankGif}\" alt=\"\" class=\"dijitCalendarIncrementControl dijitCalendarDecrease\" waiRole=\"presentation\">\n\t\t\t\t<span dojoAttachPoint=\"decreaseArrowNode\" class=\"dijitA11ySideArrow\">-</span>\n\t\t\t</th>\n\t\t\t<th class='dijitReset' colspan=\"5\">\n\t\t\t\t<div class=\"dijitVisible\">\n\t\t\t\t\t<div class=\"dijitPopup dijitMenu dijitMenuPassive dijitHidden\" dojoAttachPoint=\"monthDropDown\" dojoAttachEvent=\"onmouseup: _onMonthSelect, onmouseover: _onMenuHover, onmouseout: _onMenuHover\">\n\t\t\t\t\t\t<div class=\"dijitCalendarMonthLabelTemplate dijitCalendarMonthLabel\"></div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div dojoAttachPoint=\"monthLabelSpacer\" class=\"dijitSpacer\"></div>\n\t\t\t\t<div dojoAttachPoint=\"monthLabelNode\" class=\"dijitCalendarMonthLabel dijitInline dijitVisible\" dojoAttachEvent=\"onmousedown: _onMonthToggle\"></div>\n\t\t\t</th>\n\t\t\t<th class='dijitReset' dojoAttachPoint=\"incrementMonth\">\n\t\t\t\t<img src=\"${_blankGif}\" alt=\"\" class=\"dijitCalendarIncrementControl dijitCalendarIncrease\" waiRole=\"presentation\">\n\t\t\t\t<span dojoAttachPoint=\"increaseArrowNode\" class=\"dijitA11ySideArrow\">+</span>\n\t\t\t</th>\n\t\t</tr>\n\t\t<tr>\n\t\t\t<th class=\"dijitReset dijitCalendarDayLabelTemplate\" role=\"columnheader\"><span class=\"dijitCalendarDayLabel\"></span></th>\n\t\t</tr>\n\t</thead>\n\t<tbody dojoAttachEvent=\"onclick: _onDayClick, onmouseover: _onDayMouseOver, onmouseout: _onDayMouseOut\" class=\"dijitReset dijitCalendarBodyContainer\">\n\t\t<tr class=\"dijitReset dijitCalendarWeekTemplate\" role=\"row\">\n\t\t\t<td class=\"dijitReset dijitCalendarDateTemplate\" role=\"gridcell\"><span class=\"dijitCalendarDateLabel\"></span></td>\n\t\t</tr>\n\t</tbody>\n\t<tfoot class=\"dijitReset dijitCalendarYearContainer\">\n\t\t<tr>\n\t\t\t<td class='dijitReset' valign=\"top\" colspan=\"7\">\n\t\t\t\t<h3 class=\"dijitCalendarYearLabel\">\n\t\t\t\t\t<span dojoAttachPoint=\"previousYearLabelNode\" class=\"dijitInline dijitCalendarPreviousYear\"></span>\n\t\t\t\t\t<span dojoAttachPoint=\"currentYearLabelNode\" class=\"dijitInline dijitCalendarSelectedYear\"></span>\n\t\t\t\t\t<span dojoAttachPoint=\"nextYearLabelNode\" class=\"dijitInline dijitCalendarNextYear\"></span>\n\t\t\t\t</h3>\n\t\t\t</td>\n\t\t</tr>\n\t</tfoot>\n</table>\n"),
        value:new Date(),
        ...
        _populateGrid:function(){
            ...
            var myVar = -1;
            var month = (myVar == -1) ? (_6.getMonth() + 1) : _6.getMonth();
            if(currentMonth != _6.getMonth() || currentYear != _6.getFullYear()) {
                dojo.xhr("Get", {
                    url:"wp-content/plugins/DojoAccessibleCalendar/getDaysWithPosts.php",
                    content:{
                        "month": month,
                        "year":_6.getFullYear()
                    },
                    ...
                    load: function(data, ioArgs) {
                        myData = data;
                        console.log(ioArgs);
                        console.log("myMonth=" + data["myMonth"]);
                        console.log("myYear=" + data["myYear"]);
                        console.log("FirstPost=" + data["FirstPost"]);
                    },
                ...
                currentMonth = _6.getMonth();
                currentYear = _6.getFullYear();
            }
            _6.setDate(1);
            ...
            dojo.query(".dijitCalendarDateTemplate",this.domNode).forEach(function(_c,i){
                ...
                if(myData[_12] && !dojo.hasClass(_c,"dijitCalendarPreviousMonth") &&
                    !dojo.hasClass(_c,"dijitCalendarNextMonth")) {
                    while(_11.firstChild){
                        _11.removeChild(_11.firstChild);
                    }
                    dojo.toggleClass(_c,"dijitCalendarDateWithPosts",true);
                    _11.appendChild(dojo.create("a", {
                        innerHTML: myData[_12].id,
                        href: myData[_12].href,
                        title: myData[_12].title,
                        tabindex: 0
                    }));
//                    this.attr("value",_11);
                    dojo.connect(_11, 'onkeypress', function (evt) {
                        key = evt.keyCode;
                        if(key == dojo.keys.ENTER) {
                            dojo.stopEvent(evt);
                            for(var _228=evt.target;_228&&!_228.dijitDateValue;_228=_228.parentNode){
                            }
                            if(_228&&!dojo.hasClass(_228,"dijitCalendarDisabledDate")){
                                if(dojo.hasClass(_228,"dijitCalendarDateWithPosts")){
                                    if (_228.textContent) {
                                        window.location = myData[_228.textContent].href;
                                    } else if (_228.innerText) {
                                        window.location = myData[_228.innerText].href;
                                    } else {
                                        window.location = myData[_228.innerHTML.replace(/<[^>]*>/g,'')].href;
                                    }
                                }
                            }
                        }
                    ...
                    dojo.toggleClass(_c,"dijitCalendarDisabledDate",true);
...
//                this._setText(_11,_12);
            ...
            dojo.forEach(["previous","current","next"],function(_14){
                d.setFullYear(y++);
                this._setText(this[_14+"YearLabelNode"],this.dateLocaleModule.format(d,{
                    selector:"year",
                    locale:this.lang
                    }));
            },this);
        ...
        postCreate:function(){
            ...
            if(winloc.indexOf("/?m=") != -1) {
                var today = this.attr("value");
                var start = winloc.indexOf("/?m=") + 4;
                if(winloc.substr(start).length == 8) {
                    today.setFullYear(parseInt(winloc.substr(start, 4), 10),
                        parseInt(winloc.substr(start + 4, 2), 10) - 1,
                        parseInt(winloc.substr(start + 6, 2), 10));
                } else if(winloc.substr(start).length == 6) {
                    var fan_year = parseInt(winloc.substr(start, 4), 10);
                    var fan_month = parseInt(winloc.substr(start + 4, 2), 10);
...
//                            myData = data;
//                            console.log(ioArgs);
//                            console.log("myMonth2=" + data["myMonth"]);
//                            console.log("myYear2=" + data["myYear"]);
//                            console.log("FirstPost2=" + data["FirstPost"]);
                            today.setFullYear(parseInt(winloc.substr(start, 4), 10),
                                parseInt(winloc.substr(start + 4, 2) - 1, 10), data["FirstPost"]);
                        },
                        error: function(error) {
                            console.log(error);
                        }
        ...
        _onMonthToggle:function(evt){
            ...
            if(evt.type=="mousedown"){
                ...
                var dim={
                    width:_27.w+"px",
                    top:-this.displayMonth.getMonth()*_27.h+"px"
                    };
        ...
        _onDayClick:function(evt){
            ...
            if(_28&&!dojo.hasClass(_28,"dijitCalendarDisabledDate")){
                ...
                if(dojo.hasClass(_28,"dijitCalendarDateWithPosts")){
                    if (_28.textContent) {
                        window.location = myData[_28.textContent].href;
                    } else if (_28.innerText) {
                        window.location = myData[_28.innerText].href;
                    } else {
                        window.location = myData[_28.innerHTML.replace(/<[^>]*>/g,'')].href;
                    }
                }
            }
        },
...
//                    _2b=1;
                case dk.PAGE_UP:
//                    _2c=evt.shiftKey?"year":"month";
                    break;
                case dk.END:
//                    if (evt.shiftKey) {
//                        _2d=new Date(_2d).setMonth(12, 1);
//                        _2c="day";
//                    } else {
...
//                    this.onValueSelected(this.attr("value"));
            ...
            if(evt.keyCode != dk.PAGE_UP && evt.keyCode != dk.PAGE_DOWN) {
                this.attr("value",_2d);
            }
            if(evt.keyCode == dk.ENTER && myData[this.attr("value").getDate()]) {
                window.location = myData[this.attr("value").getDate()].href;
            }
            if(evt.keyCode == dk.UP_ARROW || evt.keyCode == dk.LEFT_ARROW) {
                var date = this.displayMonth;
                dojo.xhr("Get", {
                    url:"wp-content/plugins/DojoAccessibleCalendar/getPreviousNextMonthYearWithPosts.php",
                    content:{
                    ...
                    load: function(data, ioArgs) {
                        if(data["previousMonth"]) {
                            window.location = data["previousMonth"];
                        }
                    },
                    error: function(error) {
                        console.log(error);
            ...
            if(evt.keyCode == dk.DOWN_ARROW || evt.keyCode == dk.RIGHT_ARROW) {
                var date2 = this.displayMonth;
                dojo.xhr("Get", {
                    url:"wp-content/plugins/DojoAccessibleCalendar/getPreviousNextMonthYearWithPosts.php",
                    content:{
                        "previousOrNext":"next",
                    ...
                    load: function(data, ioArgs) {
                        if(data["nextMonth"]) {
                            window.location = data["nextMonth"];
                        }
                    },
                    error: function(error) {
                        console.log(error);
